...
function BeginnersTutorial() {
    return (
        <div className="container">
            <h2>Beginners Guide to Playing the Dilruba</h2>
            
            <h3>1. Sitting with the Dilruba</h3>
            <p>Sitting with the Dilruba correctly is crucial for proper posture and ease of play. Follow these steps:</p>
            <ul>
                <li>Sit cross-legged on the floor or use a low stool for support.</li>
            ...
            <ul>
                <li>Hold the bow lightly but firmly with your thumb and fingers.</li>
            ...
            <ul>
                <li>Familiarise yourself with the Sa Re Ga Ma (Do Re Mi) positions on the fretboard.</li>
            ...
            <ul>
                <li>Begin with the basic scale: Sa Re Ga Ma Pa Dha Ni Sa.</li>
            ...
            <ul>
                <li>Practice regularly to improve your technique and confidence.</li>
